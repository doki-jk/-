                    ...
                    <>
                      <header>
                        ...
                        <div className="header-actions">
                          ...
                          {!isToday && (
                            <button className="ghost" disabled={loading || saving} onClick={() => void loadDate(localDateKey())}>
                              返回今天
                            </button>
                          )}
                          <button className="day-toggle" disabled={loading || saving} onClick={() => void toggleTrainingDay()}>
                            <Dumbbell size={17} />{trainingDay ? '训练日' : '休息日'}
                          </button>
                          <button className="primary" disabled={loading || saving} onClick={() => openFoodModal()}>
                            <Plus size={18} />记录饮食
                          </button>
                        </div>
                      </header>
